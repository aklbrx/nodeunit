...
exports.run = function (files, options) {
    ...
    nodeunit.runFiles(paths, {
        ...
        moduleDone: function (name, assertions) {
          ...
          // try {
          //   throw new Error("Cannot display coverage stuff");
          // } catch(e) {
          //   console.log(e.stack);
          // }
          printCoverage = function(report, file) {          
            populateCoverage(report);
            reportCoverage(file, report);
          }
          ...
          // //     coverage.forEach(function(report){
        ...
        testDone: function (name, assertions) {
            ...
            // try {
            //   throw new Error("Coverage details do not exist");
            // } catch(e) {
            //   console.log(e.stack);
            // }
            ...
            //     console.log("Yes");
            //     codeCoverageDetails.forEach(function(report){
            //       populateCoverage(report);
            //       reportCoverage(report);
            //     });
            // }
...
function reportCoverage(_name, cov) {
    // console.log("This: " + _name);
    // console.log("File: " + cov[_name]);
    // Stats
    print('\n   [bold]{Test Coverage}\n');
    var sep = '   +------------------------------------------+----------+------+------+--------+',
        lastSep = '                                              +----------+------+------+--------+';
